...
package alk.asm.loader.util.exception;

import java.util.Set;

public class TransformerSortingException extends RuntimeException
{
    ...
    public <T> TransformerSortingException(String string, T node, Set<T> visitedNodes)
    {
        super(string);
